...
The Testing SDk was not designed to be run against live production URL. Try downloading the HTML for the page you want to test to a file, then run the CLI against the local file. If you are trying to test pages that live behind an authentication flow, we recommend using Cypress. 
